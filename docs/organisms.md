...
|---|---|---|---|
| `fish` | ray-finned fishes, sharks, rays, chimaeras, hagfish, lampreys | `Actinopterygii`, `Chondrichthyes`, `Elasmobranchii`, `Holocephali`, `Myxini`, `Petromyzontida` | `fishes` |
| `sharks-and-rays` | sharks, skates and rays | `Elasmobranchii` | `ray`, `rays`, `shark`, `sharks` |
| `rockfish` | Sebastes and relatives | `Sebastidae` | — |
| `crabs` | true crabs plus hermit/king/squat crabs | `Brachyura`, `Anomura` | `crab` |
| `true-crabs` | Brachyura only | `Brachyura` | — |
| `hermit-crabs` | hermit crabs | `Paguroidea` | `hermit-crab` |
| `squat-lobsters` | squat lobsters | `Galatheoidea`, `Chirostyloidea` | — |
| `shrimp` | shrimps and prawns | `Caridea`, `Dendrobranchiata`, `Stenopodidea` | `prawn`, `prawns`, `shrimps` |
| `lobsters` | clawed and spiny lobsters | `Achelata`, `Astacidea`, `Polychelida` | `lobster` |
| `barnacles` | barnacles | `Cirripedia` | `barnacle` |
| `crustaceans` | all crustaceans | `Crustacea` | — |
| `sea-stars` | starfish | `Asteroidea` | `sea-star`, `seastar`, `starfish` |
| `brittle-stars` | brittle and basket stars | `Ophiuroidea` | `brittle-star`, `brittlestar` |
| `sea-urchins` | urchins and sand dollars | `Echinoidea` | `sea-urchin`, `urchin`, `urchins` |
| `sea-cucumbers` | holothurians | `Holothuroidea` | `cucumber`, `sea-cucumber` |
| `crinoids` | feather stars and sea lilies | `Crinoidea` | `crinoid`, `feather-star` |
| `echinoderms` | all echinoderms | `Echinodermata` | — |
| `corals` | hard, soft, black and hydrocorals | `Scleractinia`, `Antipatharia`, `Octocorallia`, `Stylasteridae` | `coral` |
| `hard-corals` | stony corals | `Scleractinia` | — |
| `soft-corals` | octocorals, gorgonians, sea pens | `Octocorallia` | — |
| `black-corals` | black corals | `Antipatharia` | — |
| `sea-pens` | sea pens (current and legacy ancestor names) | `Pennatuloidea`, `Pennatulacea` | `sea-pen` |
| `anemones` | sea anemones | `Actiniaria`, `Corallimorpharia` | `anemone` |
| `tube-anemones` | cerianthid tube anemones | `Ceriantharia` | — |
| `jellyfish` | true jellyfish | `Scyphozoa`, `Cubozoa`, `Staurozoa` | `jellies`, `jelly` |
| `hydroids` | hydroids and hydromedusae | `Hydrozoa` | — |
| `cnidarians` | all cnidarians | `Cnidaria` | — |
| `ctenophores` | comb jellies | `Ctenophora` | — |
| `sponges` | all sponges | `Porifera` | `sponge` |
| `glass-sponges` | hexactinellid glass sponges | `Hexactinellida` | `glass-sponge` |
| `octopus-and-squid` | cephalopods | `Cephalopoda` | `cephalopods`, `octopus`, `squid` |
| `snails` | gastropods | `Gastropoda` | `gastropods`, `snail` |
| `nudibranchs` | nudibranch sea slugs (not all sea slugs) | `Nudibranchia` | — |
| `bivalves` | clams, mussels, scallops | `Bivalvia` | `bivalve` |
| `molluscs` | all molluscs | `Mollusca` | — |
| `worms` | segmented, ribbon and peanut worms | `Annelida`, `Nemertea`, `Sipuncula`, `Echiura` | `polychaetes`, `worm` |
| `tunicates` | sea squirts and salps | `Tunicata` | `tunicate` |
| `bryozoans` | moss animals | `Bryozoa` | — |
| `brachiopods` | lamp shells | `Brachiopoda` | — |
| `sea-spiders` | pycnogonids | `Pycnogonida` | — |
| `marine-mammals` | all mammal annotations, including whales, dolphins and seals | `Mammalia` | `mammal`, `mammals` |
| `seabirds` | all bird annotations; not restricted to seabirds | `Aves` | `bird`, `birds` |
| `algae` | red/green algae and ochrophytes (including brown algae) | `Rhodophyta`, `Chlorophyta`, `Phaeophyceae`, `Ochrophyta` | `kelp`, `seaweed` |
| `bacteria` | all bacterial annotations, including mats | `Bacteria` | — |
